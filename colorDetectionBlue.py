...
def getThresholdBlueImage(im):
    ...
    cv.InRangeS(hsv, cv.Scalar(40, 100, 100), cv.Scalar(125, 200, 200), imThreshed)
    del hsv
    return imThreshed
...
while True:
    ...
    imgBlueTresh = getThresholdBlueImage(frame) #Apply the threshold function
    ...
    if blastx > 0 and blasty > 0 and bposx > 0 and bposy > 0: #Mean we have received coordinates to print
        ...
        #When a blue object is in the frame this image will appear
